...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		stik = new FlxText(400, 55, FlxG.width - 800, "Port by stikus", 32);
		stik.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		stik.scrollFactor.set();
		stik.borderSize = 1.25;
		add(stik);
